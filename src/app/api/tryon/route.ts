...
import { moderatePerson, runStudio, STUDIO_PROMPT_VERSION } from "@/lib/studio";
...
/* Two shopper-facing finishes (model names are never disclosed to the UI):
   ...
   - "studio" → OpenAI gpt-image-2 image edit — slower, finer detail, and now
     shared with the vendor's counter bench (see lib/studio.ts).
